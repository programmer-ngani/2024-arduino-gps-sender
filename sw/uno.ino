/* Important Notice:
The source codes are provided for academic purposes only:
...
const int PirMotionRightT = 14;
const int PirMotionRightB = 15;
const int PirMotionLeftT = 16;
const int PirMotionLeftB = 17;
